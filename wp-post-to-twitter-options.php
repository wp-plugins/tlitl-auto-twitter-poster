...
<b>-</b> if you want to be unbanned, send me your site's url and tell me that you was banned and a pomise to fix what was overloading us.<br />
        <b>**</b> My email is [ mohandez@hotmail.com ]
            ...
            <br /><br />
<b>NOTE:</b> TLI.TL system is going to be upgraded soon, every user should have an API key so that he can use the system.<br />
Please register an account <a href="http://tli.tl/register.php" target="_blank"> here </a> so that we can send you Your API.
