        ...
        <?php wp_nonce_field('update-options'); ?>
            <table id="twitter-setting-form" class="form-table">
                <tr>
                    ...
                    <td><input type="text" class="regular-text" name="wp_post_to_twitter_TLI.TL_apikey" id="TLI.TL_apikey" value="<?=$apikey;?>" /></td>
                </tr>                                            
                <tr>
            	...
            	<input type="hidden" name="page_options" value="wp_post_to_twitter_twitter_username,wp_post_to_twitter_twitter_password,wp_post_to_twitter_twitter_prefix,wp_post_to_twitter_twitter_apikey" />
