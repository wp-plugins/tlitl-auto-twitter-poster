       ...
       <div class="wrap">
        ...
        <?php wp_nonce_field('update-options'); ?>
            <table id="twitter-setting-form" class="form-table">
                ...
                <tr>
                    <th scope="row"><label for="twitter_apikey"><?=__('Tweet apikey');?></label></th>
                    <td><input type="text" class="regular-text" name="wp_post_to_twitter_twitter_apikey" id="twitter_apikey" value="<?=$apikey;?>" /></td>
                </tr>                                
            </table>
