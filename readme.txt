...
= 3.0 =
* changing the method of twitter posting

= 3.5 =
* Adding a check that tli.tl service is working and using the original post link of not working
