<?php
    ...
    */
    ...
    function wp_post_to_twitter_install () {
        add_option ('wp_post_to_twitter_TLI.TL_apikey', '');
    ...
    function wp_post_to_twitter_remove () {
        delete_option ('wp_post_to_twitter_TLI.TL_apikey');
...
///////////////// TLI.TL shortener
    ...
    if($apikey){
    $u = @file_get_contents("http://tli.tl/apiwp/".$l."/".$apikey);
    }else{
    $u = $l;
    }
    return $u;
...
///////////////// TLI.TL shortener    
    ...
    function wp_post_to_twitter_options () {
        $apikey = get_option ('wp_post_to_twitter_TLI.TL_apikey');
